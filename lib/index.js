...
function Menu(bus, xid, menuPath, menu)
{
    ...
    bus.setMethodCallHandler(menuPath, 'com.canonical.dbusmenu', 'AboutToShow', [
       function(id) {
           ...
           return [0]; // ned update? TODO api to return value from event handler? 1) use eventflow OR 2) replace event with plane callback
       },
    ...
    // without this call menu is not shown
